...
while 0 < 6:
    _BLACKLIST = get(
        "https://raw.githubusercontent.com/SendiAp/Reforestation/master/manblacklist.json"
    )
...
while 0 < 6:
    _WHITELIST = get(
        "https://raw.githubusercontent.com/SendiAp/Reforestation/master/whitelist.json"
    )
