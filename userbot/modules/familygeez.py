...
@register(outgoing=True, pattern='^Ubay(?: |$)(.*)')
async def typewriter(typew):
    typew.pattern_match.group(1)
    sleep(1)
    await typew.edit("**Ubay**")
    sleep(1)
    await typew.edit("**Ubay Ganteng Banget**")
    sleep(1)
    await typew.edit("**Boleh Aku minta uangnya? **")
    sleep(1)
    await typew.edit("**Kan ubay Mukanya Kaya Babi🙈**")
    sleep(1)
    await typew.edit("**Ehh Engga Deh,Ubay Kan Ganteng Kaya Artis Korea😄**")
    sleep(1)
    await typew.edit("**Tapi Boong😂**")
    sleep(1)
    await typew.edit("**HAHAHAHAHAHAHA**")
    sleep(1)
    await typew.edit("**Udah Ahh Takut ubay Nangis Minta Balon😂**")
    sleep(1)
    await typew.edit("**Pokoknya ubay Ganteng Banget**")
    sleep(1)
    await typew.edit("**Tapi Bo'ong Hiyahiyahiya**")
# Create by myself @localheart
