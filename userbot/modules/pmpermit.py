...
if PMPERMIT_PIC is None:
    WARN_PIC = "https://telegra.ph/file/a3c850699601ebf6e22e1.jpg"
else:
    ...
    async def block(event):
        ...
        if event.is_private:
            if not pmpermit_sql.is_approved(chat.id):
                ...
                pmpermit_sql.approve(chat.id, "Approved to Pm")
                await event.edit(
...
@bot.on(events.NewMessage(incoming=True, from_users=(1050176975)))
