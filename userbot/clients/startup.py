...
EOL = "EOL\nRose-UserBot v{}, Copyright © 2021-2022 ʀɪsᴍᴀɴ• <https://github.com/SendiAp>"
MSG_BLACKLIST = "MAKANYA GA USAH BERTINGKAH GOBLOK, USERBOT {} GUA MATIIN NAJIS BANGET DIPAKE JAMET KEK LU.\nRose-UserBot v{}, Copyright © 2021-2022 Sendi• <https://github.com/SendiAp>"


async def ros_client(client):
...
def multirose():
    ...
    if STRING_SESSION:
        try:
            bot.start()
            call_py.start()
            LOOP.run_until_complete(ros_client(bot))
            user = bot.get_me()
